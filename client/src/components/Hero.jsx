      ...
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
          <div className="flex flex-col items-start gap-2">
            ...
            >
              <option value="">Pichup Location</option>
              {cityList.map((city) => (
        ...
        <motion.button
            ...
            whileTap={{scale: 0.95}}
         className="flex items-center justify-center gap-1 px-6 py-3 max-sm:mt-4 bg-primary-dull text-white rounded-full cursor-pointer">
          <img 
